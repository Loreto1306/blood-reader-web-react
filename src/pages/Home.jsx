...
export default function Home(){
    return(
        <>
        <div  className="">
        <div  className ="bg-cyan-700 flex justify-between my-48 h-full">
    <div className="text-white max-w-lg lg:ml-48">
        ...
        <div className="mt-10 mb-10 mr-6">
            <a href="#" className="bg-cyan-900 rounded-3xl shadow-2xl border-transparent border-r border-b border-l border-t py-3 px-10 font-medium inline-block mr-4 hover:bg-cyan-800  hover:text-white duration-300 hover:border border">Leia Mais</a>
